...
const Hero = () => {
  return (
    <section className="h-[80vh] xl:h-screen relative text-white">
      ...
      <div className="container h-full mx-auto flex flex-col items-center xl:flex-row z-30 relative">
        {/* text */}
        <div
        data-scroll
        data-scroll-speed="0.4"
        className=" flex-1 flex flex-col text-center items-center justify-center xl:pb-12 gap-10 h-full ">
          {/* badge and h1 */}
